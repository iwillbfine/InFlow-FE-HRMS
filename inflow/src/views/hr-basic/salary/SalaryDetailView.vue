    ...
    <div class="table-wrapper">
      <TableItem class="salary-table" gtc="repeat(4, 1fr)" br="0.5rem">
        ...
        <TableRow>
          ...
          <TableCell class="mid" fs="1.7rem">국민연금
            <div class="tooltip-wrapper">
              <i class="tooltip-icon"
                 @mouseenter="showTooltip('과세금액의 4.5%를 공제하며, 비과세금액이 있을 경우 비과세액을 제외한 과세금액에서만 세액이 공제됩니다.', '국민연금')"
                 @mouseleave="hideTooltip('국민연금')">?</i>
              <div v-if="isTooltipVisible['국민연금']" class="tooltip">{{ tooltipText['국민연금'] }}</div>
            </div>
          </TableCell>
          ...
          <TableCell class="mid" fs="1.7rem">건강보험
            <div class="tooltip-wrapper">
              <i class="tooltip-icon"
                 @mouseenter="showTooltip('과세금액의 3.545%를 공제하며, 비과세금액이 있을 경우 비과세액을 제외한 과세금액에서만 세액이 공제됩니다.', '건강보험')"
                 @mouseleave="hideTooltip('건강보험')">?</i>
              <div v-if="isTooltipVisible['건강보험']" class="tooltip">{{ tooltipText['건강보험'] }}</div>
            </div>
          </TableCell>
          ...
          <TableCell class="mid" fs="1.7rem">장기요양
            <div class="tooltip-wrapper">
              <i class="tooltip-icon"
                 @mouseenter="showTooltip('건강보험 금액의 12.95%를 공제합니다.', '장기요양')"
                 @mouseleave="hideTooltip('장기요양')">?</i>
              <div v-if="isTooltipVisible['장기요양']" class="tooltip">{{ tooltipText['장기요양'] }}</div>
            </div>
          </TableCell>
          ...
          <TableCell class="mid" fs="1.7rem">고용보험
            <div class="tooltip-wrapper">
              <i class="tooltip-icon"
                 @mouseenter="showTooltip('과세금액의 0.9%를 공제하며, 비과세금액이 있을 경우 비과세액을 제외한 과세금액에서만 세액이 공제됩니다.', '고용보험')"
                 @mouseleave="hideTooltip('고용보험')">?</i>
              <div v-if="isTooltipVisible['고용보험']" class="tooltip">{{ tooltipText['고용보험'] }}</div>
            </div>
          </TableCell>
          ...
          <TableCell class="mid" fs="1.7rem">소득세
            <div class="tooltip-wrapper">
              <i class="tooltip-icon"
                 @mouseenter="showTooltip('부양가족수와 20세 이하 자녀수에 따라, 국세청의 근로소득 간이세액표 자료를 기준으로 공제됩니다.', '소득세')"
                 @mouseleave="hideTooltip('소득세')">?</i>
              <div v-if="isTooltipVisible['소득세']" class="tooltip">{{ tooltipText['소득세'] }}</div>
            </div>
          </TableCell>
          ...
          <TableCell class="mid" fs="1.7rem">지방소득세
            <div class="tooltip-wrapper">
              <i class="tooltip-icon"
                 @mouseenter="showTooltip('소득세의 10%를 공제합니다.', '지방소득세')"
                 @mouseleave="hideTooltip('지방소득세')">?</i>
              <div v-if="isTooltipVisible['지방소득세']" class="tooltip">{{ tooltipText['지방소득세'] }}</div>
            </div>
          </TableCell>
