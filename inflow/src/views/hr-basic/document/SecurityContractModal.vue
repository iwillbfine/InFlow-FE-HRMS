    ...
    <div v-if="contractData" class="modal-overlay">
      <div class="modal-content">
        ...
        <div class="contract-container" ref="contractViewer">
          ...
          <div class="contract">
          <p><strong>소 속:</strong> <span class="highlight">{{ contractData.department_name }}</span></p>
          <p><strong>성 명:</strong> <span class="highlight">{{ contractData.employee_name }}</span></p>
          <p><strong>생년월일:</strong> <span class="highlight">{{ contractData.birth_date }}</span></p>
          <br>
          <p class="intro">
            위 본인은 <span class="highlight">{{ contractData.start_date }}</span>자로
            <span class="highlight">{{ contractData.company_name }}</span>(이하 "회사")에 입사하여 회사의 영업비밀 및 영업자산의 중요성과 관련한 규정을 충분히 이해하였기에, 다음 사항을 준수할 것을 서약합니다.
          </p>
          <br>
          <ol>
            <li>1. 본인은, 아래와 같은 정보가 회사의 영업비밀에 해당함을 확인하며, 회사의 관련 규정을 준수할 것을 서약합니다.
              <ul>
                <li>① 영업비밀 관리규정 기타 회사의 내부 규정에 기재된 영업비밀 보호대상</li>
                <li>② 영업비밀임이 표시된 기술자료, 공장 배치도, 제품 설계도면 등</li>
                <li>③ 통제구역, 시건장치, 패스워드 등으로 접근이 제한된 정보</li>
                <li>④ 회사가 영업비밀로 지정한 기타 비밀정보</li>
              </ul>
            </li>
            <li>2. 본인은, 회사 재직 중 및 퇴사 후에도 회사의 영업비밀을 비밀로 유지하고 누설하지 않을 것을 서약합니다.</li>
            <li>3. 본인은, 회사에 재직 중 취득한 회사의 주요 정보 및 영업비밀에 대한 모든 권리가 회사의 소유임을 인정합니다.</li>
            <li>4. 본인은, 회사의 승인을 받지 않고는 회사의 영업비밀을 복제하거나 보관하지 않을 것을 서약합니다.</li>
            <li>5. 본인은, 타인의 영업비밀을 침해하지 않을 것이며, 필요한 경우 회사와 상의할 것을 서약합니다.</li>
            <li>6. 본인은, 회사의 승인 없이 동종 또는 유사업체와 겸직하거나 자문을 제공하지 않을 것을 서약합니다.</li>
            <li>7. 본인은, 회사의 컴퓨터 및 정보처리 장치를 업무 목적으로만 사용할 것을 서약합니다.</li>
            <li>8. 본인은, 퇴사 시 회사의 자료를 반납하며 사본을 보유하지 않을 것을 서약합니다.</li>
          </ol>
