<template>
  <CommonArticle label="파견 신청" w="90%">
    <TableItem gtc="2fr 6fr">
      ...
      <TableRow>
        <TableCell class="h-7" th fs="1.6rem">파견지</TableCell>
...
const handleOnclick = async () => {
  ...
  const response = await createDispatchRequest({
...
const goMoreList = () => {
  router.push('/hr-basic/attendance/dispatch/requests');
};
